    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'host' => 'us-cluster-east-01.k8s.cleardb.net', //$host,  //env('DB_HOST', '127.0.0.1')
            'port' => env('DB_PORT', '3306'),
            'database' => 'heroku_692072083e684ac', //$database, //env('DB_DATABASE', 'forge')
            'username' => 'b414f86a077b4d', //$username,   //env('DB_USERNAME', 'forge')
            'password' => 'be1cda10', //$password,                               //env('DB_PASSWORD', '')
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
